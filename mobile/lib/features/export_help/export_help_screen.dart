...
class ExportHelpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Finding your activity file')),
      body: SafeArea(
        child: ListView(
  ...
  static const _iosSteps = [
    ...
    'Tap "On My iPhone" in the sidebar, then open the "Simple Activity Tracker" folder.',
    'Open the "runs" folder — each activity is a file named with the date and time it started.',
  ...
  static List<String> _androidSteps(String? exportedTo) => [
    if (exportedTo != null)
      ...
      'Open your Files or "My Files" app and go to Downloads > SimpleActivityTracker.',
    'Each activity is a file named with the date and time it started.',
